...
ADDR = (IP, PORT)
SIZE = 1000000
FORMAT = "ISO-8859-1" #"utf-8"
SERVER_DATA_PATH = r"/Users/beaudlyleriche/Documents/Class/GT Senior Year/ECE 3872/Director/upload_files"        # MODIFIABLE: Change server data path as needed.
